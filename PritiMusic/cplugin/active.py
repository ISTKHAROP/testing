...
async def clone_active_chats(client: Client, message: Message):
    ...
    # Fetch Served Chats for this specific clone bot
    try:
    ...
    # FILTERING (Check how many of the global active chats belong to THIS clone bot)
    my_audio_count = 0
    if global_audio:
