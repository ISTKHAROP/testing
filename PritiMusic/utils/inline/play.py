...
# 🎧 Specific Premium Emoji IDs for Controls
PLAY_EMOJI = 6158973722255429425     # ▶️
PAUSE_EMOJI = 4970176665062736422    # ⏸️
REPLAY_EMOJI = 5350396951407895212   # ↻ (Reused EQ/Gear for Replay)
SKIP_EMOJI = 4969851488793788974     # ⏭️
STOP_EMOJI = 6129486856212979482     # 🛑
EMOJI_CLOSE = 5408916593780470262    # ❌
...
# 🔘 Smart Button Creator (With Emoji Support)
...
def track_markup(_, videoid, user_id, channel, fplay):
    ...
    buttons = [
        ...
        [
            ...
            create_btn(text=_["CLOSE_BUTTON"], cb=f"forceclose {videoid}|{user_id}", style=s_map[2], emoji_id=EMOJI_CLOSE)
        ],
    ]
    return buttons
...
def telegram_markup(_, chat_id):
    ...
    buttons = [
        [
            ...
            create_btn(text=_["CLOSEMENU_BUTTON"], cb="close", style=s_map[2], emoji_id=EMOJI_CLOSE),
        ],
    ]
    return buttons
